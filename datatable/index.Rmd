...
This tutorial demonstrates how to create interactive tables like the one below (built in R using the [DT](https://rstudio.github.io/DT/) library). We also compare DT with [rhandsontable](http://jrowen.github.io/rhandsontable/#introduction). Note that there are three interactive shiny apps associated with this tutorial:
